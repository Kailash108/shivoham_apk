  ...
  return(
    ...
    <View style={{marginTop: Constants.statusBarHeight}}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={0} style={styles.time}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={300} style={styles.time}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={600} style={styles.time}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={900} style={styles.time}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={1200} style={styles.time}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={1500} style={styles.time}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={1800} style={styles.time}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={2100} style={styles.time}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={2400} style={styles.time}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={2700} style={styles.time}>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={3000} style={styles.time}>
        ...
        <View>
          <Text style={styles.places}>Trimbakeshwar:</Text>
          <Animatable.Text animation="fadeInUp" delay={3300} style={styles.time}>
          According to Shiva Purana, it was a request from river Godavari, Gautam Rishi with many other Gods to reside Lord Shiva there as Trimbakeshwar. Once, Gautam Rishi was given boon from Lord Varuna with a power of unlimited supply of food and grains. This made feel jealous among other gods. So they decided to send a cow to his grain stock. Gautam Rishi killed the cow accidentally. 
          After realizing his mistake he went to Lord Shiva to clean his sins and purify the premises. Lord Shiva after hearing his prayer asked Ganga to flow through the land to clean all his sins and resided beside the river in the form of Trimbakeshwar Jyotirlinga.
          </Animatable.Text>             
        </View>
        ...
        <View>
          ...
          <Animatable.Text animation="fadeInUp" delay={3600} style={styles.time}>
