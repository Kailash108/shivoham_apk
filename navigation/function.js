...
const styles = StyleSheet.create({
    ...
    return (
      <ScrollView style={styles.container}>
        <LinearGradient colors={['indigo', 'slateblue']}>
          ...
          <View>
            <Text style={{color: 'white', textAlign: 'center'}}>Version: [1.5]</Text>
          </View>

          <View style={{alignItems: 'center'}}>
            <Image style={{height: 300, width: 250, marginTop: 10, borderColor: 'gold', borderWidth: 1}} source={{uri: 'https://dz0qr9vdflcrm.cloudfront.net/wp-content/uploads/2017/08/lord-shiva.jpg'}} />
          
            <View>
              <Text style={{color: 'gold', fontSize: 30}}>Mahadev</Text>
            </View>
            ...
            <View>
              <Text style={{fontSize: 15, fontWeight: 'bold', backgroundColor: 'khaki', color: 'black', alignSelf: 'center', borderRadius: 18}}>
  ...
  function Contact(){
    return (
      <ScrollView>
        <LinearGradient colors={['indigo', 'mediumslateblue', 'hotpink']}>

        <View>
          
          <Text style={{color: 'gold', lineHeight: 30, letterSpacing: 3, textTransform: 'capitalize', fontWeight: 'bold', flex: 1}}>
              {'\t\t\t\t\t\t\t\t\t\t\t\t\t'}
              ...
              we recalls is, his mantra, <Text style={{textTransform: 'uppercase'}}>OM NAMAH SHIVAYA.{'\n-------------'}</Text>
          </Text>
          
          <View>
              <Text style={{textDecorationLine: 'underline', backgroundColor: 'white',color: 'black', fontSize: 20, alignSelf: 'center'}}>
                {'>>'} The Things Around Shiva {'<<'}
              </Text>
          </View>

          <View>
            <Text style={{color: 'orange', fontSize: 20, alignSelf: 'center', marginTop: 20}}>
            ...
            <Text style={{color: 'white', fontSize: 20, alignSelf: 'center', marginTop: 20}}>
            ...
            <Text style={{color: 'springgreen', fontSize: 20, alignSelf: 'center', marginTop: 20}}>
            ...
            <Text style={{color: 'gold', fontSize: 20, alignSelf: 'center', marginTop: 20}}>
               <Text style={{fontWeight: 'bold'}}>4. Third Eye: </Text>Alertness, Knowledge and Wisdom are all related  to the third eye
            </Text>

            <Text style={{color: 'yellow', fontSize: 20, alignSelf: 'center', marginTop: 20}}>
            ...
            <Text style={{color: 'midnightblue', fontSize: 20, alignSelf: 'center', marginTop: 20}}>
...
function Home1(){
  ...
  function somnath(){
    return (
        <ScrollView>
          <LinearGradient colors = {['indigo', 'hotpink', 'slateblue', 'midnightblue']}>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 300, width: 350, alignSelf: 'center'}} source={{uri: 'https://somnath.org/Areas/Xpanel/Content/img/01c0ef4b-8.jpg'}} />
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 300, width: 350, alignSelf: 'center'}} source={{uri: 'https://www.organiser.org/Encyc/2019/9/12/2_03_28_09_Srisailam-Temple_1_H@@IGHT_359_W@@IDTH_640.jpg'}} />
                <View style={{width: 200}}>
                  <TouchableOpacity>
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 300, width: 350, alignSelf: 'center'}} source={{uri: 'https://5.imimg.com/data5/DL/LB/TA/ANDROID-26492615/product-jpeg-500x500.jpg'}} />
                <View style={{width: 200}}>
                    <TouchableOpacity>
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 300, width: 350, alignSelf: 'center'}} source={{uri: 'https://www.oyorooms.com/travel-guide/wp-content/uploads/2020/01/omkareshwar-cityscape-dusk.jpg'}} />
                <View style={{width: 200}}>
                    <TouchableOpacity>
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 400, width: 350, alignSelf: 'center'}} source={{uri: 'https://i.pinimg.com/originals/12/b3/f5/12b3f51d60f63bb566d5b2a5e9526f64.jpg'}} />
                <View style={{width: 200}}>
                  <TouchableOpacity>
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 300, width: 350, alignSelf: 'center'}} source={{uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcR_KMOyTeFyRhQ58QMIL-RzI3ear50tdNEHOg&usqp=CAU'}} />
                <View style={{width: 200}}>
                  <TouchableOpacity>
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 300, width: 350, alignSelf: 'center'}} source={{uri: 'https://ffo.gov.in/uploads/location_photos/Bhimashankar-Jyotirlinga3-1.jpg'}} />
                <View style={{width: 200}}>
                  <TouchableOpacity>
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 300, width: 350, alignSelf: 'center'}} source={{uri: 'https://media-cdn.tripadvisor.com/media/attractions-splice-spp-540x360/09/1a/91/76.jpg'}} />
                <View style={{width: 200}}>
                  <TouchableOpacity>
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 300, width: 350, alignSelf: 'center'}} source={{uri: 'https://cdn.s3waas.gov.in/s3559cb990c9dffd8675f6bc2186971dc2/uploads/bfi_thumb/2018031279-olw8xqqrzx20xf8qzhr0fpnv86m57ygkh9ljis7qmi.jpg'}} />
                <View style={{width: 200}}>
                  <TouchableOpacity>
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 300, width: 350, alignSelf: 'center'}} source={{uri: 'https://www.trawell.in/admin/images/upload/900551700Dwarka_Nageshwar_Temple_main.jpg'}} />
                <View style={{width: 200}}>
                    <TouchableOpacity>  
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 250, width: 350, alignSelf: 'center'}} source={{uri: 'https://seoimgak.mmtcdn.com/blog/sites/default/files/images/Rameshwaram-temple.jpg'}} />
                <View style={{width: 200}}>
                  <TouchableOpacity>
            ...
            <Text>{'\n\n'}</Text>
            <View style={{alignItems: 'center'}}> 
                <Image style={{height: 200, width: 350, alignSelf: 'center'}} source={{uri: 'https://www.aurangabadtourism.in/images/places-to-visit/header/grishneshwar-jyotirlinga-temple-aurangabad-tourism-entry-fee-timings-holidays-reviews-header.jpg'}} />
                <View style={{width: 200}}>
                  <TouchableOpacity>
  ...
  function nandi(){
    return(
      <ScrollView>
        <View>
        <LinearGradient colors={['lightpink', 'darkviolet', 'gold']}>
          <View style={{alignItems: 'center'}}>
            <Image style={{height: 300, width: 250, marginTop: 30, borderWidth: 2, borderColor: 'black', alignSelf: 'center'}} source={{uri: 'https://i.pinimg.com/474x/94/83/b4/9483b4a9b2acdc87943818cda1966586.jpg'}} />
          ...
          <View style={{alignItems: 'center'}}>
            ...
            <Image source={{uri: 'https://cdn.britannica.com/26/142626-050-01A227C8/Statue-Nandi-bull-Chamundi-Hill-Karnataka-India.jpg'}} style={{height: 200, width: 300, marginTop: 30, borderWidth: 2, borderColor: 'black', alignSelf: 'center'}} />
          </View>
        ...
        <View>
          <Text style={{backgroundColor: 'white', alignSelf: 'center', fontSize: 30, textDecorationLine: 'underline'}}>Nandi Flag</Text>
          <Image source={{uri: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/NandiFlag.svg/330px-NandiFlag.svg.png'}} style={{height: 200, width: 300, marginTop: 30, borderWidth: 2, borderColor: 'black', alignSelf: 'center'}} />
          <Text style={{fontSize: 20}}>{'\n'}It is also known as Vrishaba Flag, A flag which is recognized as 'THE FLAG OF SAIVISM' {'\n\n'}This Flag Has Been Designed By Ravindhra Sastry of Madurai, Tamil Nadu, in the guidance of Danapala S, a Sri Lankan. {'\n\n-------------'} </Text>
        </View>
    ...
    return (
      <ScrollView>
        ...
        <View>
          ...
          <View>
            <Image style={styles1.images} source={{uri: 'https://harshtravelblogger.files.wordpress.com/2019/09/yamunotri-temple.jpg?w=790'}}/>
          </View>
          ...
          <View>
            <Image style={styles1.images} source={{uri: 'https://lh3.googleusercontent.com/proxy/XpO9Vk4XHP4KaRd0yGfMu3a9IsouBLBkFiAxmK6CfHoWLl5tSvdGMrYqhcErU5CYXCe1QMmVyzvPy5b18lTuo9C2Fvnk2dikDW_I_GXob6PH_UVt7ErvfrkpnptmZQ'}}/>
          </View>
          <Text>{'\n'}</Text>
